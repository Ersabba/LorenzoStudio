 ...
 */
public class StoricoTaskDto implements Serializable
{
	...
	public boolean equals (Object other)
	{
		...
		if (other instanceof StoricoTaskDto) {
			StoricoTaskDto dto = (StoricoTaskDto) other;
			return (
				                 (id == dto.getId ()) &&
				...
				(lastStateUpdateTime == dto.getLastStateUpdateTime () || lastStateUpdateTime != null && lastStateUpdateTime.equals (dto.getLastStateUpdateTime ())) &&
				    (additionalInfos == dto.getAdditionalInfos ()     || additionalInfos != null     && additionalInfos.equals (dto.getAdditionalInfos ())) &&
				       (activityCode == dto.getActivityCode ()        || activityCode != null        && activityCode.equals (dto.getActivityCode ())) &&
