...
public class ParamChecker {
    ...
    public ParamChecker()
        ...
        public static void checkMatricolaLenntCliente(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.lenntID");
        ...
        public static void checkNumeroUtenza(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.userNum");
            ParamUtils.checkNotNull(name, value);
            ParamUtils.checkNumeric(name, value);
        ...
        public static void checkMatricolaAL(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.ctId");
            ParamUtils.checkNotNull(name, value);
            ParamUtils.checkNumeric(name, value);
            ParamUtils.checkLength(name, value, 13, 13);
        }
        ...
        public static void checkCodConcentratore(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.ccsId");
            ParamUtils.checkNotNull(name, value);
            ParamUtils.checkNumeric(name, value);
            ParamUtils.checkLength(name, value, 13, 13);
        }
        ...
        public static void checkCodCabinaSecondaria(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.csId");
            ParamUtils.checkNotNull(name, value);
        ...
        public static void checkCodLineaMt(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.mvLineId");
            ParamUtils.checkNotNull(name, value);
            ParamUtils.checkLength(name, value, 13, 13);
        ...
        public static void checkMatricolaTrasformatore(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.transformerId");
        ...
        public static void checkCodTiputt(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.userType");
            ParamUtils.checkNotNull(name, value);
        ...
        public static int checkGiornoSettimana(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.weekDay");
            
            String dOW = "";
            String[] valueSet = { "Monday","Tuesday","Wednesday", "Thursday",
           		                  "Friday","Saturday","Sunday", "WeekHoliday" };
            			
            for(int k=0;k<valueSet.length;++k) {
            	if( (dOW=LoadGreBundle.getProperty("day."+valueSet[k].toLowerCase())) != null)
            		valueSet[k] = dOW;            	
            }
        ...
        public static void checkStatoAlleggerimento(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.reductStatus");
            String valueSet[] = {
                "Attivo", "Disattivo"
            };
            ParamUtils.checkValueSet(name, value, valueSet);
        ...
        public static void checkStatoFunzionamento(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.opStatus");
            String valueSet[] = {
                "OK", "KO"
            };
            ParamUtils.checkValueSet(name, value, valueSet);
        ...
        public static void checkStatoConcentratore(String value)
            throws Exception
        {
            String name = LoadGreBundle.getProperty("errors.ccsStatus");
            String valueSet[] = {
