...
@Embeddable
public class FileRouCurrentId implements Serializable{
    ...
    public FileRouCurrentId(){};

    public FileRouCurrentId(String codiceConcentratore, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileRouCurrentId other = (FileRouCurrentId) obj;
