...
public class MonthlyPowerId implements Serializable, Cloneable {
	...
	public MonthlyPowerId() {}
	
	public MonthlyPowerId(String matricolaLenntCliente,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final MonthlyPowerId other = (MonthlyPowerId) obj;
		if (componentId == null) {
	...
	public Object clone() {
		MonthlyPowerId ret = new MonthlyPowerId();
