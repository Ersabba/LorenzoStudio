...
public class MensileErFrazId implements java.io.Serializable, Cloneable {
	...
	public MensileErFrazId(String matricolaLenntCliente, String mese, String anno) {
		super();
	...
	public MensileErFrazId(String matricolaLenntCliente, Date referenceDate) {
		super();
	...
	public boolean equals(Object o) {
		...
		MensileErFrazId that = (MensileErFrazId) o;
