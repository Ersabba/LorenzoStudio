...
@Embeddable
public class FileAddressId implements Serializable{
    ...
    public FileAddressId(){};

    public FileAddressId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileAddressId other = (FileAddressId) obj;
