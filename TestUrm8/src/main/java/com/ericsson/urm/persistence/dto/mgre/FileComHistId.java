...
@Embeddable
public class FileComHistId implements Serializable{
    ...
    public FileComHistId(){};

    public FileComHistId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileComHistId other = (FileComHistId) obj;
