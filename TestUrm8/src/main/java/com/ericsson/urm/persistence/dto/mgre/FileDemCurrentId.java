...
@Embeddable
public class FileDemCurrentId implements Serializable{
    ...
    public FileDemCurrentId(){};

    public FileDemCurrentId(String codiceConcentratore, String matricola) {
	...
	public String toString() {
		return "FileComId [codiceConcentratore=" + codiceConcentratore 
				+ ", matricola=" + matricola + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileDemCurrentId other = (FileDemCurrentId) obj;
