...
@Embeddable
public class FileComCurrentId implements Serializable{
    ...
    public FileComCurrentId(){};

    public FileComCurrentId(String codiceConcentratore, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileComCurrentId other = (FileComCurrentId) obj;
