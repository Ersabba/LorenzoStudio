...
@Embeddable
public class FileRoutingId implements Serializable{
    ...
    public FileRoutingId(){};

    public FileRoutingId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public String toString() {
		return "FileRoutingId [codiceConcentratore=" + codiceConcentratore + ", acquisitionDate=" + acquisitionDate
				+ ", matricola=" + matricola + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileRoutingId other = (FileRoutingId) obj;
