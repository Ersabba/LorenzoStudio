...
@Embeddable
public class FileRouHistId implements Serializable{
    ...
    public FileRouHistId(){};

    public FileRouHistId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileRouHistId other = (FileRouHistId) obj;
