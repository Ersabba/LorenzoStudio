...
public class MensileReattAssFrazId implements java.io.Serializable, Cloneable {
	...
	public MensileReattAssFrazId() {

	}

	public MensileReattAssFrazId(String matricolaLenntCliente, String mese, String anno) {
		super();
	...
	public MensileReattAssFrazId(String matricolaLenntCliente, Date referenceDate) {
		super();
	...
	public boolean equals(Object o) {
		...
		MensileReattAssFrazId that = (MensileReattAssFrazId) o;
