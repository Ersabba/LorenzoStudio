...
public class LoadCurvesWeb implements Serializable {
	private static final long serialVersionUID = -1;
	
	private LoadCurvesWebId id=null;	         
	...
	public LoadCurvesWeb() {}

	public LoadCurvesWeb(LoadCurvesWebId id, PeriodoCurve periodoCurve, Date dataAcquisizione,Long componentValue) {
	...
	public LoadCurvesWebId getId() {
		return id;
	}
	public void setId(LoadCurvesWebId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LoadCurvesWeb other = (LoadCurvesWeb) obj;
