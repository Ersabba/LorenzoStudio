...
public class LenntCliente implements Serializable, MgdbDto {
	...
	private Date   		timestampAssLennt			= null;
	private Date   		dataPrimaAssCg  			= null;
	private Date   		ultimoContattoAdd  			= null;
	private Date   		lastPunctualFailure	        = null;
//	private Long        idProfiloLettura            = null;
	...
	public Object clone() {
		try {
			...
			if (timestampAssLennt != null)
				lc.timestampAssLennt = (Date) timestampAssLennt.clone();
			if (dataPrimaAssCg != null)
				lc.dataPrimaAssCg = (Date) dataPrimaAssCg.clone();
	...
	public void applyAllProperties(MgdbDto srcDto) {
		...
		this.timestampAssLennt = other.timestampAssLennt;
		this.dataPrimaAssCg = other.dataPrimaAssCg;
		this.ultimoContattoAdd = other.ultimoContattoAdd;
		this.lastPunctualFailure = other.lastPunctualFailure;
//		this.idProfiloLettura = other.idProfiloLettura;
	...
	public TipoUtenza getUtenzaSpeciale() {
		return TipoUtenza.parse(this.utenzaSpeciale);
	}

	public void setUtenzaSpeciale(TipoUtenza utenzaSpeciale) {
		if (utenzaSpeciale != null)
			this.utenzaSpeciale = utenzaSpeciale.dbValue;
		else
			this.utenzaSpeciale = null;
	}
	...
	public Date getTimestampAssLennt() {
		return timestampAssLennt;
	}

	public void setTimestampAssLennt(Date timestampAssLennt) {
		this.timestampAssLennt = timestampAssLennt;
	}	

	public Date getDataPrimaAssCg() {
		return dataPrimaAssCg;
	}

	public void setDataPrimaAssCg(Date dataPrimaAssCg) {
		this.dataPrimaAssCg = dataPrimaAssCg;
	}	
...
//	}
	...
	public String toString() {
		return "LenntCliente [matricolaLenntCliente=" + matricolaLenntCliente
				+ ", codConcentratore=" + codConcentratore + ", codTipmodin="
				+ codTipmodin + ", giornoSettimana=" + giornoSettimana
				+ ", coeffLimitazione=" + coeffLimitazione + ", codConfigAll="
				+ codConfigAll + ", codTiputt=" + codTiputt
				+ ", codGruppoApplicativo=" + codGruppoApplicativo
				+ ", codLineaBt=" + codLineaBt + ", codSezione=" + codSezione
				+ ", flagRipetitore=" + flagRipetitore + ", progLenntGruppo="
				+ progLenntGruppo + ", caratteristicaInstallazione="
				+ caratteristicaInstallazione + ", raggLennt=" + raggLennt
				+ ", statoAllegEmerg=" + statoAllegEmerg + ", guastoLennt="
				+ guastoLennt + ", statoAllegProgr=" + statoAllegProgr
				+ ", presenzaDatiSegr=" + presenzaDatiSegr + ", codPosizione="
				+ codPosizione + ", indirizzo=" + indirizzo + ", costruttore="
				+ costruttore + ", tipo=" + tipo + ", annoFabbricazione="
				+ annoFabbricazione + ", progressivoAnno=" + progressivoAnno
				+ ", matrDistrEnerg=" + matrDistrEnerg + ", lingua=" + lingua
				+ ", releaseFirmware=" + releaseFirmware + ", numTelGuasti="
				+ numTelGuasti + ", numTelInfo=" + numTelInfo
				+ ", numeroUtenza=" + numeroUtenza + ", fase=" + fase
				+ ", faseOld=" + faseOld + ", dataFase=" + dataFase
				+ ", ultimoContatto=" + ultimoContatto + ", cabinaSecondaria="
				+ cabinaSecondaria + ", tipoAlimentazione=" + tipoAlimentazione
				+ ", tipoAssegnazione=" + tipoAssegnazione
				+ ", codConcentratore2=" + codConcentratore2
				+ ", codConcentratore3=" + codConcentratore3
				+ ", utenzaSpeciale=" + utenzaSpeciale + ", flagAbilitazione="
				+ flagAbilitazione + ", billingMode=" + billingMode
				+ ", indirizzoHDLC=" + indirizzoHDLC + ", gruppoHDLC="
				+ gruppoHDLC + ", progressivoHDLC=" + progressivoHDLC
				+ ", timestampAssLennt=" + timestampAssLennt
				+ ", dataPrimaAssCg=" + dataPrimaAssCg + ", ultimoContattoAdd="
				+ ultimoContattoAdd + ", lastPunctualFailure="
				+ lastPunctualFailure + ", carrier=" + carrier 
				+ "]"; //+ ", idProfiloLettura=" + idProfiloLettura 
	}
