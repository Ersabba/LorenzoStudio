...
public class StatoCampioneCdcId implements Serializable {
	...
	public StatoCampioneCdcId() {}

	
	public StatoCampioneCdcId(Date dataCurva, String matricolaLenntCliente,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final StatoCampioneCdcId other = (StatoCampioneCdcId) obj;
		if (componentId == null) {
