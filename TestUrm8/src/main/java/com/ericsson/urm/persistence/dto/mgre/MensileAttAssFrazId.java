...
public class MensileAttAssFrazId implements java.io.Serializable, Cloneable {
	...
	public MensileAttAssFrazId(String matricolaLenntCliente, String mese, String anno) {
		super();
	...
	public MensileAttAssFrazId(String matricolaLenntCliente, Date referenceDate) {
		super();
	...
	public String toString() {
		return "MensileAttAssFrazId [anno=" + anno + ", matricolaLenntCliente=" + matricolaLenntCliente + ", mese=" + mese + "]";
	}
	...
	public boolean equals(Object o) {
		...
		MensileAttAssFrazId that = (MensileAttAssFrazId) o;
