...
public class MonthlyRegister implements Serializable, Cloneable {
	private static final long serialVersionUID = -1;
	
	private MonthlyRegisterId id=null;
	...
	public MonthlyRegisterId getId() {
		return id;
	}
	public void setId(MonthlyRegisterId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final MonthlyRegister other = (MonthlyRegister) obj;
	...
	public Object clone() {
		MonthlyRegister ret = new MonthlyRegister();
		
		ret.id = (MonthlyRegisterId)id.clone();
