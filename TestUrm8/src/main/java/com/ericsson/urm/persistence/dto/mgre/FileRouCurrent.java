...
@Entity
@Table(name="FILEROU")
public class FileRouCurrent  implements Serializable {
	private static final long serialVersionUID = 1L;

    @EmbeddedId
    private FileRouCurrentId fileRouId;
    ...
    public FileRouCurrent(){}

	public FileRouCurrent(FileRouCurrentId fileRouId, String rip1, String rip2, String rip3, String rip4, Date dataRif,
	...
	public FileRouCurrentId getFileRouId() {
		return fileRouId;
	}

	public void setFileRouId(FileRouCurrentId fileRouId) {
		this.fileRouId = fileRouId;
	}
	...
	public String toString() {
		return "FileRouCurrent [fileRouId=" + fileRouId + ", rip1=" + rip1 + ", rip2=" + rip2 + ", rip3=" + rip3
				+ ", rip4=" + rip4 + ", dataRif=" + dataRif + ", acquisitionDate=" + acquisitionDate + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileRouCurrent other = (FileRouCurrent) obj;
