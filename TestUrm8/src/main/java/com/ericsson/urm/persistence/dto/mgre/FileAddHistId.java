...
@Embeddable
public class FileAddHistId implements Serializable{
    ...
    public FileAddHistId(){};

    public FileAddHistId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public String toString() {
		return "FileAddressId [codiceConcentratore=" + codiceConcentratore + ", acquisitionDate=" + acquisitionDate
				+ ", matricola=" + matricola + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileAddHistId other = (FileAddHistId) obj;
