...
public class LoadCurvesId implements Serializable {
	...
	public LoadCurvesId(Date dataCurva, String matricolaLenntCliente,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LoadCurvesId other = (LoadCurvesId) obj;
		if (componentId == null) {
