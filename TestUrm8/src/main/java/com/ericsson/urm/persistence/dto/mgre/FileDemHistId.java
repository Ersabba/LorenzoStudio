...
@Embeddable
public class FileDemHistId implements Serializable{
    ...
    public FileDemHistId(){};

    public FileDemHistId(String codiceConcentratore, Date acquisitionDate, String matricola) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileDemHistId other = (FileDemHistId) obj;
