...
public class CurvaCaricoPuntualeBufferId implements Serializable {
	...
	public CurvaCaricoPuntualeBufferId() {
		
	}

	public CurvaCaricoPuntualeBufferId(Date dataCurva, String matricolaLenntCliente, int numPeriodo, String componentId) {
	...
	public boolean equals(Object o) {
		...
		CurvaCaricoPuntualeBufferId that = (CurvaCaricoPuntualeBufferId) o;
