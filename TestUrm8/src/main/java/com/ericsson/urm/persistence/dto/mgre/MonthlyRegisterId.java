...
public class MonthlyRegisterId implements Serializable, Cloneable {
	...
	public MonthlyRegisterId() {}
	
	
	public MonthlyRegisterId(String matricolaLenntCliente, String mese,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final MonthlyRegisterId other = (MonthlyRegisterId) obj;
		if (anno == null) {
			if (other.anno != null)
				return false;
	...
	public Object clone() {
		MonthlyRegisterId ret = new MonthlyRegisterId();
