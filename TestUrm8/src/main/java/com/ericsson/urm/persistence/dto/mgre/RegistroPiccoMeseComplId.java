...
public class RegistroPiccoMeseComplId implements RegistroPiccoMeseId {
	private static final long serialVersionUID = -1L;
	private static Logger logger = Logger.getLogger(RegistroPiccoMeseComplId.class);
	...
	public RegistroPiccoMeseComplId(String matricolaLenntCliente,
			String annoRilevazione, String meseRilevazione, String registro,
			String componentId) {
		super();
		this.matricolaLenntCliente = matricolaLenntCliente;
		this.annoRilevazione = ("0000"+annoRilevazione).substring(annoRilevazione.length());
		this.meseRilevazione = ("00"+meseRilevazione).substring(meseRilevazione.length());
	...
	public RegistroPiccoMeseComplId() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegistroPiccoMeseComplId other = (RegistroPiccoMeseComplId) obj;
	...
	public Object clone() {
		RegistroPiccoMeseComplId ret = null;
		try {
			ret = (RegistroPiccoMeseComplId)super.clone();	
		} 
	...
	public String toString() {
		return "RegistroPiccoMeseComplId [matricolaLenntCliente=" + matricolaLenntCliente + ", annoRilevazione="
				+ annoRilevazione + ", meseRilevazione=" + meseRilevazione + ", registro=" + registro + ", componentId="
				+ componentId + "]";
	}
