...
public class LoadCurves implements Serializable {
	private static final long serialVersionUID = -1;
	
	private LoadCurvesId id=null;	         
	...
	public LoadCurves(LoadCurvesId id, PeriodoCurve periodoCurve, Date dataAcquisizione,Long componentValue) {
	...
	public LoadCurvesId getId() {
		return id;
	}
	public void setId(LoadCurvesId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LoadCurves other = (LoadCurves) obj;
