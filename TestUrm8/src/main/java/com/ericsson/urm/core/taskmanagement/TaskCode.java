...
public enum TaskCode {
	...
	EXPORT_ONESHOT_CDC("A174"),   
	RECUPERO_REGISTRI_STORICI_LENNT("A175"),
	RECOVERY_CCS_FILES("A176"),  //A176 riservato per CR047(Integrazione URM-Concentratore multiservizio)
    STATISTICHE_LENNT_ORARI("A177"), 
	ACQ_FILE_COM("A178"),
	ELAB_FILE_COM("A179"),
	...
	BONIFICA_IP_CCS("A191"),
	SASStatoCCS("A192"),
	PPopulateMissingLoadCurves("PPopulateMissingLoadCurves");
