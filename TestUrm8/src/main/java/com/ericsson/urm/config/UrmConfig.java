...
//		public static final String CHARACTER_REPLACE_MAP = "character.replace.map";
	...
	public static interface ModuleWebResourcesTypeKeys{		 
	 ...
	 public static interface MailNotifier{
		 public final static String SMTP_PROVIDER="urm.notifica.provider";
		 public final static String SMTP_PORT="urm.notifica.port";
		 public final static String SMTP_MITTENTE="urm.notifica.mittente";
	 }
	...
	public synchronized String getWebAppPathResources(String contextPath, String typeResources) {
	 ...
	 public synchronized String getTestEnv(){
		 ...
		 return getBooleanProperty(GenericKeys.ENVIRONMENT_TEST, false)?"_test":"";
