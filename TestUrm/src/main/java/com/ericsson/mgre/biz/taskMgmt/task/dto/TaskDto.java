...
public class TaskDto implements Serializable
{
	...
	public TaskDto.State getState () {
		return state;
	}
	
	public void setState (TaskDto.State state) {
		this.state = state;
	}
	...
	public TaskDto.TargetType getTargetType () {
		return targetType;
	}
	
	public void setTargetType (TaskDto.TargetType targetType) {
